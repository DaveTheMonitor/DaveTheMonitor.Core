...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawScriptTools")]
    internal static class DrawScriptToolsPatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.ScriptTools;
        private const WorldDrawOptions _option = WorldDrawOptions.ScriptTools;
