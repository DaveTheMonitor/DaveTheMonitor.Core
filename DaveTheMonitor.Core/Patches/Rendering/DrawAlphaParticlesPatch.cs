...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawAlphaParticles")]
    internal static class DrawAlphaParticlesPatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.Particles;
        private const WorldDrawOptions _option = WorldDrawOptions.Particles;
