...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawZones")]
    internal static class DrawZonesPatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.Zones;
        private const WorldDrawOptions _option = WorldDrawOptions.Zones;
