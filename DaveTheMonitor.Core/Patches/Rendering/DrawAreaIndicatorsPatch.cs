...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawAreaIndicators")]
    internal static class DrawAreaIndicatorsPatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.AreaIndicators;
        private const WorldDrawOptions _option = WorldDrawOptions.AreaIndicators;
