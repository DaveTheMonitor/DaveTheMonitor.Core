...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawClouds")]
    internal static class DrawCloudsPatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.Clouds;
        private const WorldDrawOptions _option = WorldDrawOptions.Clouds;
