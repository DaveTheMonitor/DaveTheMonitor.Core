...
{
    [Patch("StudioForge.TotalMiner.Renderers.MapRenderer", "DrawSwingTargetFrame")]
    internal static class DrawSwingTargetFramePatch
    {
        private const WorldDrawStage _stage = WorldDrawStage.SwingTarget;
        private const WorldDrawOptions _option = WorldDrawOptions.SwingTarget;
