...
{
    [Patch("StudioForge.TotalMiner.MapChunkTM", "DecoratePendingCore")]
    internal static class MapChunkTMDecoratePendingCorePatch
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original)
        {
            Type type = typeof(MapChunkTMDecoratePendingCorePatch);
