...
{
    [Patch("StudioForge.TotalMiner.ChunkGeneratorBase", "Initialize")]
    internal static class ChunkGeneratorBaseInitializePatch
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original)
        {
            Type type = typeof(ChunkGeneratorBaseInitializePatch);
            ...
            while (index != -1)
            {
                ...
                index = list.FindIndex(i => i.LoadsField(field));
            }
